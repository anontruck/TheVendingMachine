...
set _xil_proj_name_ "vending_machine"
...
# Create project
create_project $_xil_proj_name_ $origin_dir/$_xil_proj_name_ -force -part xc7a35tcpg236-1
...
set obj [get_filesets sources_1]
set_property -name "top" -value "vending_machine" -objects $obj
...
set files [list \
"[file normalize "$origin_dir/src/sim/vending_machine_tb.v"]"\
]
add_files -norecurse -fileset $obj $files
...
# set file "[file normalize "$origin_dir/src/xdc/vending_machine.xdc"]"
# set file [file normalize $file]
# set file_added [add_files -norecurse -fileset $obj $file]
# set file "$origin_dir/src/xdc/vending_machine.xdc"
# set file [file normalize $file]
...
# NOTE: zsmith - if we add any block sources, they'll need to be created here
# source $origin_dir/src/bd/
# Generate wrapper
# make_wrapper -files [get_files "${_xil_proj_name_}.bd] -top
